package com.example.jianzhang.common.aop;

import cn.hutool.core.util.StrUtil;
import com.example.jianzhang.common.configuration.CodeMessageConfiguration;
import com.example.jianzhang.vo.UnifyResponseVO;
...
public class ResultAspect {
    ...
    @Pointcut("execution(public * com.example.jianzhang.controller..*.*(..))")
